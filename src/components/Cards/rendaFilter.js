                    ...
                    <Label check>
                      <Input
                        ...
                        onChange={() => {
                          ...
                          sãoJoséDoRioPreto ? retirarRegiao('sãoJoséDoRioPreto') : adicionarRegiao('sãoJoséDoRioPreto')
                        }}
                      />
                    ...
                    <Label check>
                      <Input
                        ...
                        onChange={() => {
                          ...
                          riberãoPreto ? retirarRegiao('riberãoPreto') : adicionarRegiao('riberãoPreto')
                        }}
                      />
                      <span className="form-check-sign"></span>
                       Riberão Preto
                    ...
                    <Label check>
                      <Input
                        ...
                        onChange={() => {
                          ...
                          araçatuba ? retirarRegiao('araçatuba') : adicionarRegiao('araçatuba')
                        }}
                      />
                      <span className="form-check-sign"></span>
                       Araçatuba
                    ...
                    <Label check>
                      <Input
                        ...
                        onChange={() => {
                          ...
                          valeDoParaíba ? retirarRegiao('valeDoParaíba') : adicionarRegiao('valeDoParaíba')
                        }}
                      />
                      <span className="form-check-sign"></span>
                       Vale Do Paraíba
                    ...
                    <Label check>
                      <Input
                        ...
                        onChange={() => {
                          ...
                          araraquara ? retirarRegiao('araraquara') : adicionarRegiao('araraquara')
                        }}
                      />
                      <span className="form-check-sign"></span>
                       Araraquara
                    ...
                    <Label check>
                      <Input
                        ...
                        onChange={() => {
                          ...
                          piracicaba ? retirarRegiao('piracicaba') : adicionarRegiao('piracicaba')
                        }}
                      />
                      <span className="form-check-sign"></span>
                       Piracicaba
                                      ...
                                      <Label check>
                                          <Input
                                            ...
                                            onChange={() => {
                                              ...
                                              rendaMaior ? retirarOpcao('rendaMaior') : adicionarOpcao('rendaMaior')
                                            }}
                                          />
                                          <span className="form-check-sign"></span>
                                           Renda Maior
                                      ...
                                      <Label check>
                                          <Input
                                            ...
                                            onChange={() => {
                                              ...
                                              rendaMenor ? retirarOpcao('rendaMenor') : adicionarOpcao('rendaMenor')
                                            }}
                                          />
                                          <span className="form-check-sign"></span>
                                           Renda Menor
                                          ...
                                          <Input
                                            ...
                                            onChange={() => {
                                              ...
                                              rendaMedia ? retirarOpcao('rendaMedia') : adicionarOpcao('rendaMedia')
                                            }}
                                          />
                                          <span className="form-check-sign"></span>
                                           Renda Média
